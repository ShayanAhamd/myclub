                            ...
                            <form class="form-horizontal" action="#" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="name" placeholder="Name Here" value="<?php echo $row["name"]; ?>" name="name" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="name" placeholder="Product Price " value="<?php echo $row["price"]; ?>" name="price" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control"  name="quantity" placeholder="Product Quantity" value="<?php echo $row["quantity"]; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea  class="form-control" id="description" rows="4" placeholder="Description Here" name="description" required><?php echo $row["description"]; ?>
                                            </textarea>
                                        </div>
                                    </div>
...
if (isset($_POST["submit"])) {
       ...
       $date_time = $time.$date;
        ...
        $sql = "UPDATE `products` SET `name`=' $name',`category`='$category',`price`='$price',`description`='$description',`quantity`='$quantity',`additional_info`='$additional_info',`date`='$date_time' WHERE `id` = '$id' ";
