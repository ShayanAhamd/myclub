                                    ...
                                    <div class="row py-4">
                                        ...
                                        <div class="col-lg-6 mx-auto">
                                            ...
                                            <form action="" method="POST" enctype="multipart/form-data">
                                              ...
                                              <div class="image-area mt-4"><img id="imageResult" src="<?php echo $_SESSION["image"]; ?>" alt=""
                                                    class="img-fluid rounded shadow-sm mx-auto d-block"></div>


                                                <div class="input-group mb-3 mt-5 px-2 py-2 rounded-pill bg-white shadow-sm">

                                                    <input id="upload2" type="file" name="image"
                                                        onchange="readURL2(this);" class="form-control border-0"
                                                        >
                                                    <label id="upload-label2" for="upload2"
                                                ...
                                                <div class="image-area2 mt-4"><img id="imageResult2" src="#" alt=""
                                                    class="img-fluid rounded shadow-sm mx-auto d-block"></div>
                                                ...
                                                <div class="form-group mt-5 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="name" class="form-control" id="name" placeholder="Product Name Here" value="<?php echo $_SESSION["name"]; ?>" >
                                                    </div>
                                                </div>

                                                <div class="text-center">
                                                    <button type="submit" name="btn_submit" class="btn  shadow-sm m-4"
                                                        value=""
                                                        style="background-color: #0891FF;;letter-spacing: 0.6px;border-radius: 2px;color: #FFF; display: inline-block; vertical-align: middle;">Update
                                                        Profile</button>
...
if (isset($_POST["btn_submit"])) {
    ...
    $sql = "UPDATE `admin` SET `name`='$name',`image`='$image' WHERE  `id` = 1";
