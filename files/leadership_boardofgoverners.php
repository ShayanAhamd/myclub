...
<body style="font-family: sans-serif;">
    ...
    ?>
    <div class="container text-center spacing pb-3 pt-0 mt-0">
        <span><a href="./leadership.php" class="saftey_link pr-3">LEADERSHIP</a></span> |
        <span><a href="./leadership.php" class="saftey_link_2 pl-3">SENIOR LEADERSHIP TEAM</a></span>
        <span><a href="./leadership_boardofgoverners.php" class="saftey_link_2 pl-5"><b>BOARDOF GOVERNERS</b></a></span>
        <span><a href="./leadership_trustees.php" class="saftey_link_2 pl-5">TRUSTEES</a></span>
    </div>
    <div class="container-fluid video_bg pb-5">
        <div class="container">
            <div class="row">
                <div class="col-12 pl-0 pl-lg-5">
                    <h1 class="senior_hding pl-0 pl-lg-5 pt-5">
                        The Power of People
                    </h1>
                    <p class="pl-0 pl-lg-5 senior_para pt-3">
    ...
    <!-- ................................................. -->
    <!-- ================================================= -->
    <div class="container pl-5 pl-lg-5 pb-5">
        <div class="pt-4">
            <a href="" class="links pl-5">Home</a> > <a href="" class="links">About Us</a> > <span
                class="leader_text">Board of Governers</span>
        </div>
        <!-- ................................................. -->
        <div class="container pl-lg-5 pt-5">
            <div class="row">
                <div class="col-12 col-lg-3 pl-0 pl-lg-5">
                    <a href="">
                        <img src="../images/leadership/shahid.jpeg" alt="" width="100%" height="100%">
                    </a>
                </div>
                <div class="col-12 col-lg-8 pl-0">
                    <h1>
                        <a href="" class="img_hding">
                            Shahid Afridi
                        </a>
                    </h1>
                    <p class="img_para">
        ...
        <div class="container pl-lg-5 pt-5">
            <div class="row">
                <div class="col-12 col-lg-3 pl-0 pl-lg-5">
                    <a href="">
                        <img src="../images/leadership/amjad.jpeg" alt="" width="100%" height="100%">
                    </a>
                </div>
                <div class="col-12 col-lg-8 pl-0">
                    <h1>
        ...
        <div class="container pl-lg-5 pt-5">
            <div class="row">
                <div class="col-12 col-lg-3 pl-0 pl-lg-5">
                    <a href="">
                        <img src="../images/leadership/khawaja.jpeg" alt="" width="100%" height="100%">
                    </a>
                </div>
                <div class="col-12 col-lg-8 pl-0">
                    <h1>
        ...
        <div class="container pl-lg-5 pt-5">
            <div class="row">
                <div class="col-12 col-lg-3 pl-0 pl-lg-5">
                    <a href="">
                        <img src="../images/leadership/asif.jpeg" alt="" width="100%" height="100%">
                    </a>
                </div>
                <div class="col-12 col-lg-8 pl-0">
                    <h1>
        ...
        <div class="container pl-lg-5 pt-5">
            <div class="row">
                <div class="col-12 col-lg-3 pl-0 pl-lg-5">
                    <a href="">
                        <img src="../images/leadership/tasawar.jpeg" alt="" width="100%" height="100%">
                    </a>
                </div>
                <div class="col-12 col-lg-8 pl-0">
                    <h1>
                        <a href="" class="img_hding">
                            SQL(R). Tasawar Alam Awan
                        </a>
                    </h1>
                    <p class="img_para">
                        Treasurer
        ...
        <hr style="border:1px solid rgb(220,215,214);" class="mt-5 mb-0">
    </div>
    <!-- ================================================= -->
    <!-- ................................................. -->
    <!-- ================================================= -->
