...
<head>
    ...
    <link rel="stylesheet" href="../css/kids_elevate_youth_voices.css">
    <!-- .........External CSS For Home.......... -->
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav header-list w-100">
                                <li class="nav-item mx-auto active w-100">
                                    <a class="nav-link saftey_link pt-3" href="./kids_saftey_threats.php">SAFTEY THREATS</a>
                                </li>
                                <li class="nav-item mx-auto active w-100">
                                    <a class="nav-link saftey_link pt-3" href="./kids_workforce_readiness.php">W F READINESS</a>
                                </li>
                                <li class="nav-item mx-auto active w-100">
                                    <a class="nav-link saftey_link pt-3" href="./kids_cycle_of_inequity.php">CYCLES OF INEQUITY</a>
                                </li>
                                <li class="nav-item mx-auto active w-100">
                                    <a class="nav-link saftey_link pt-3" href="./kids_elevate_youth_voices.php"><b>ELEVATE YOUTH VOICES</b></a>
                                </li>
                                <li class="nav-item mx-auto active w-100">
                                    <a class="nav-link saftey_link pt-3" href="./kids_mentorship_voice.php">MENTORSHIP VOID</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-8 pl-5 pt-3 border_right">
                        ...
                        <p class="video_para">
                            All voices deserve to be heard but in today’s society, youth often don’t feel safe, and
                            can’t advocate for themselves. We advocate for kids and provide them with a platform to
                            express themselves in an intentional and effective manner, as well as the necessary tools to
                            be tolerant of voices that are different from their own.
                        </p>
                        <p class="video_para">
                            We help kids elevate their voices. We show them that their opinions, feelings, and
                            perspectives matter. They stand up and speak out—and the world is taking notice.
                        </p>
                    </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12 text-center">
                            <div class="progress purple">
                                ...
                                <div class="progress-value" style="background-color:rgb(255,130,0)">
                                    <img src="../images/kids_cycle_of_inequity/Infogaphic_CMSelfConfidence_icon.png"
                                        alt="" height="70px" width="70px" style="margin-bottom: 15px;margin-left: 2px;">
                                </div>
                            </div>
                        </div>
                        <p class="giph_text_4 pl-5 pr-5">
                            <span class="purple">89%</span> of Club youth said they can stand up for what is right; 91%
                            of Club youth reported that as a leader, they make sure everyone feels important.
                        </p>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="row pl-4">
                        <div class="col-12 col-lg-4 pt-4">
                            ...
                            <p class="story_text pt-3">
                                Taylor is so thankful for the Club every day, but especially now.
                            </p>
                        </div>
                        <div class="col-12 col-lg-4 pt-4">
                            <div class="main">
                            ...
                            <p class="story_text pt-3">
                                Bullying can be difficult to deal with, but it’s not impossible to overcome.
                            </p>
                        </div>
                        <div class="col-12 col-lg-4 pt-4">
                            <div class="main">
                                <img src="../images/images/img-dk.jpeg" alt="Notebook" style="width:100%; height:250px">
                                <div class="content text-center">
                                    <h1>
                                        <a class="text">
                                            Hope to Homeless
                            ...
                            <p class="story_text pt-3">
                                Helping Serenity serve more homeless people in Central Florida.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-12 pb-5">
                    <div class="row pl-4">
                        <div class="col-12 col-lg-2 pt-4"> </div>
                        <div class="col-12 col-lg-4 pt-4">
                            <div class="main">
                                <img src="../images/images/img-jfnf.jpeg" alt="Notebook"
                                    style="width:100%; height:230px">
                                <div class="content text-center">
                                    <h1>
                                        <a class="text">
                                            Club Kids' Digital Needs
                                        </a>
                                    </h1>
                                </div>
                            </div>
                            <p class="story_text pt-3">
                                Teaching Club kids to dream big and encouraging them to be leaders in their communities.
                            </p>
                        </div>
                        <div class="col-12 col-lg-4 pt-4">
                            <div class="main">
                                <img src="../images/images/img-mmd.jpeg" alt="Notebook"
                                    style="width:100%; height:230px">
                                <div class="content text-center">
                                    <h1>
                                        <a class="text">
                            ...
                            <p class="story_text pt-3">
                                Every student in every neighborhood should be provided with a high-quality education.
                            </p>
                        </div>
