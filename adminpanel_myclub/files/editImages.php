        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ?>
        <?php if($img==1) {?>
        <img id="imageResult1" src="../images/<?php echo $row["image1"]; ?>" alt="" class="img-fluid rounded shadow-sm mx-auto d-block">
        <?php }else if($img==2) {?>
        <img id="imageResult1" src="../images/<?php echo $row["image2"]; ?>" alt="" class="img-fluid rounded shadow-sm mx-auto d-block">
        <?php }else if($img==3) {?>
        <img id="imageResult1" src="../images/<?php echo $row["image3"]; ?>"   alt="" class="img-fluid rounded shadow-sm mx-auto d-block">
        <?php }else if($img==4) {?>
        <img id="imageResult1" src="../images/<?php echo $row["image4"]; ?>"   alt="" class="img-fluid rounded shadow-sm mx-auto d-block">
        <?php }?>
...
if( $image != null){
    ...
    if($img == 1){
        $sql = "UPDATE `product_images` SET `image1`='$image' WHERE `product_id` = '$id'";
    }else if($img == 2){
        $sql = "UPDATE `product_images` SET `image2`='$image' WHERE `product_id` = '$id'";
    }else if($img == 3){
        $sql = "UPDATE `product_images` SET `image3`='$image' WHERE `product_id` = '$id'";
    }else if($img == 4){
        $sql = "UPDATE `product_images` SET `image4`='$image' WHERE `product_id` = '$id'";
    }
