                            ...
                            <form class="form-horizontal" action="#" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="title" class="form-control"  name="title" placeholder="Title of News & Stories" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                        <input type="text"  class="form-control"  name="image_alt" placeholder="Image Alternative" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="title" class="form-control"  name="posted_by" placeholder="Posted BY" required>
                                        </div>
                                    </div>
...
if (isset($_POST["submit"])) {
        ...
        $sql = "INSERT INTO `news_stories`( `category`, `title`, `image`, `image_alt`, `posted_by`, `date`, `details`) VALUES ('$category','$title','$image','$image_alt','$posted_by' ,'$date','$detail')";
     
        $result = mysqli_query($link, $sql);

        if ($result) {

            echo '<script type="text/javascript">alert("News & Stories Add Successfully");</script>';
