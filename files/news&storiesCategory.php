...
<body style="font-family: sans-serif;">
 ...
 <!-- ================================================= -->
    ...
    <!-- ================================================= -->
                ...
                $sql = "SELECT * FROM `news_stories` WHERE `category` = '$category'  ORDER BY `id` DESC limit 1";
 ...
 <!-- ================================================= -->
    ...
    <!-- ================================================= -->
                <?php
                    ...
                    $sql = "SELECT * FROM `news_stories` WHERE `category` = '$category'  ORDER BY `id` DESC limit 1,1";
        ...
        <div class="w-md-75 mx-auto">
            <div class="row my-3">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM `news_stories` WHERE `category` = '$category'  ORDER BY `id` DESC limit 2,1";
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM `news_stories` WHERE `category` = '$category'  ORDER BY `id` DESC limit 3,1";
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM `news_stories` WHERE `category` = '$category'  ORDER BY `id` DESC limit 4,1";
            ...
            <div class="row my-3">
             <!-- ================================================= -->
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM `news_stories` WHERE `category` = '$category'  ORDER BY `id` DESC limit 5,1";
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM `news_stories` WHERE `category` = '$category'  ORDER BY `id` DESC limit 6,1";
            ...
            <div class="row my-3">
             <!-- ================================================= -->
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM `news_stories` WHERE `category` = '$category'  ORDER BY `id` DESC limit 7,1";
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM `news_stories` WHERE `category` = '$category'  ORDER BY `id` DESC limit 8,1";
            ...
            <div class="row my-3">
             <!-- ================================================= -->
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM `news_stories` WHERE `category` = '$category'  ORDER BY `id` DESC limit 9,1";
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM `news_stories` WHERE `category` = '$category'  ORDER BY `id` DESC limit 10,1";
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM `news_stories` WHERE `category` = '$category'  ORDER BY `id` DESC limit 11,1";
