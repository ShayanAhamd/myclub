...
<div class="row py-4">
    <div class="col-lg-6 mx-auto">
        ...
        <img id="imageResult1" src="../images/<?php echo $row["image"]; ?>" alt="" class="img-fluid rounded shadow-sm mx-auto d-block">
...
if( $image != null){
    ...
    $image = $imageUrl.$image;
        ...
        $sql = "UPDATE `news_stories` SET `image`='$image' WHERE `id` = '$id'";
